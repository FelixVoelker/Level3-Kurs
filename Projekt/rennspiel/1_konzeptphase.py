""" Tag 1: Konzeptphase und Prototyping
    ...
    3. Wenn der Spieler die Pfeiltaste nach links drückt, dann wechselt
       das Auto eine Spur nach links sofern möglich.
    4. Wenn der Spieler die Pfeiltaste nach rechts drückt, dann wechselt
       das Auto eine Spur nach rechts sofern möglich.
    5. Überholt der Spieler ein Auto erhält er einen Punkt.
    6. Kollidiert das Auto des Spielers mit einem anderen Fahrzeug,
